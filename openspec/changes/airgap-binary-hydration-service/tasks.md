...
- [x] 1.7 Define Phase 1 Definition of Ready from GitHub issue #7: Azure service/SKU parity, selected Pulp/PostgreSQL/image-mirroring methods, local harness pass, required controls, and Phase 1 milestone criteria.
